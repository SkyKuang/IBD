...
class AutoAttack():
    def __init__(self, model, norm='Linf', eps=.3, seed=None, verbose=True,
        ...
        if not self.is_tf_model:
            ...
            self.square = SquareAttack(self.model, p_init=.8, n_queries=1000, eps=self.epsilon, norm=self.norm,
        ...
        if version in ['standard', 'plus', '1','2','3','4','5','6','7','rand']:
    ...
    def set_version(self, version='standard'):
        ...
        if version == 'standard':
            ...
            self.attacks_to_run = ['apgd-t', 'fab-t']
        else:
            pass